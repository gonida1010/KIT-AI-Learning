...
📺 **시연 영상** : [YouTube에서 보기](https://youtu.be/fpB69Sh-itA)

<details>
<summary>🏆 KIT 바이브코딩 공모전 포스터</summary>
<br>
<img width="350" alt="바이브코딩_공모전_포스터" src="https://github.com/user-attachments/assets/fc960746-5e5c-4831-a6a7-cf102e7fce48" />
</details>
...
| **Agent B**      | 학습·조교 지원 | 멘토 자료 RAG 기반 학습 응답, 보충수업 예약, 브리핑 리포트 자동 생성             |
...
- **RAG (Retrieval-Augmented Generation)**: 학원 공지·취업 자료와 담당 멘토 학습 자료를 FAISS로 검색하여 학습·행정 응답에 컨텍스트 주입
- **멘토 자료 관리**: 멘토별 최신 자료/기초 자료를 분리 저장, 각각 독립 벡터스토어로 검색
- **자료 노출 제어**: 질문과 직접 관련되어 AI 응답에 참조된 멘토 자료만 수강생 화면에 카드로 제공
- **일반 대화 최적화**: 큐레이션 또는 멘토 자료 요청이 아닌 Agent A 대화에서는 해당 검색 호출을 생략
